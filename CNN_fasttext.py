...
def objective(trial):
    ...
    fname = f"ft_{embed_size}_{w2v_epochs}_{win_size}_{sg}.txt"
    if fname not in w2v_file:
        model = FastText(texts, size=embed_size, window=win_size, min_count=1, workers=6,iters=w2v_epochs,sg=sg)
